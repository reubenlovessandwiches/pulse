  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Reddit Dashboard</h1>
              ...
              {stats?.topUsers?.map((u, idx) => (
                <div key={u.user.id} className="flex items-start gap-4 py-3 first:pt-0 last:pb-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <RedditUserLink username={u.user.username} className="font-medium text-sm" />
              ...
              {stats?.topThemes?.map((t, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 w-full">
                    <span className="font-mono text-xs text-muted-foreground/60 w-4 shrink-0">{(idx+1).toString().padStart(2, '0')}</span>
                    <div className="flex-1 min-w-0">
