...
import { Activity, Globe, FileText, Monitor, LogOut } from "lucide-react";
      ...
      <header className="shrink-0 border-b border-border bg-card/50 glass">
        <div className="px-4 pt-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <div className="bg-primary flex items-center justify-center w-8 h-8 rounded-lg shadow-sm shadow-primary/30">
